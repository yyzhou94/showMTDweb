...
app_manager.require_app('ryu.app.sdnhub_apps.fileserver')
app_manager.require_app('ryu.app.sdnhub_apps.host_tracker_rest')
app_manager.require_app('ryu.app.sdnhub_apps.stateless_lb_rest')
app_manager.require_app('ryu.app.sdnhub_apps.tap_rest')
