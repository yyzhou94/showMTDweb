...
class TopoDiscoverRest(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        mapper = wsgi.mapper
        mapper.connect('topo', '/v1.0/topo/turnon',
...
class TopoDiscoverController(ControllerBase):
    ...
    def enable_topo(self,req, **kwargs):
        ...
        topo_controller.topo_controller_enable = True
        print "topo_controller.topo_controller_enable = %s "  %topo_controller.topo_controller_enable
        return Response(status=200,content_type='application/json',
                    body=json.dumps({'status':'success'}))