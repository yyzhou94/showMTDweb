...
if mininet:
    ...
    MAC_ADDR = ['00:00:00:00:00:'+'%02d' %(i+1) for i in range(22)]
...
class PortScan(app_manager.RyuApp):
    ...
    def packet_in_handler(self, ev):
        ...
        if out_port != ofproto.OFPP_FLOOD:
            if ((in_port in switch_link_hosts[dpid] and switch_link_hosts[dpid][in_port][0]==src) or
                    (out_port in switch_link_hosts[dpid] and switch_link_hosts[dpid][out_port][0]==dst)):
