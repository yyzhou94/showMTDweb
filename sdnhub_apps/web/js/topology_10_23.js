...
var element = function(elm, x, y, label) {
    var cell = new elm({ position: { x: x, y: y }, size: { width: 70, height: 30 },
...
$.getJSON(url.concat("/v1.0/topology/hosts"), function(hosts){
            ...
            if (obj.port.dpid in switchList && hostDom != undefined) {
                ...
                hostList[key]['tooltip'] = new joint.ui.Tooltip({
                        ...
                        content: '<table>' +
                                 ...
                                 '<tr><td>Assoc switch:</td><td>' + obj.port.dpid + '</td></tr>' +
                                 '<tr><td>Assoc port:</td><td>' + obj.port + '</td></tr>' +
                                 '<tr><td>Time seen:</td><td>' + dateStr + '</td></tr>' +
                                 '</table>',
                        top: hostDom,
                        direction: 'top'
        ...
        joint.layout.DirectedGraph.layout(graph, { setLinkVertices: false, edgeSep: 20, rankSep: 80, nodeSep: 5 });
    });
};
...
$.getJSON(url.concat("/v1.0/topology/switches"), function(switches){
    ...
    $.each(switches, function(index, value){
        ...
        var switchName = 's' + parseInt(obj.dpid);  
